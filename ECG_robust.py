...
class WatermarkEmbedding:
    ...
    def _split_signal_to_subsequences(ecg_signal, subsequence_length: int) -> list:
    ...
    def get_watermarked_subsequences(ecg_subsequences):
        ...
        for ecg_subseq in ecg_subsequences:
            ...
            modified_magnitude = WatermarkEmbedding._apply_watermark_to_subsequences(watermark, magnitudes, param.power)
...
watermark              = WatermarkEmbedding._turn_watermark_to_nonbinary_sequence(ssn_with_hamming)
